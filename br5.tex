...
Simple families contain numbers of the form $(ab^n+c)/d$ for some fixed $a$, $b$, $c$, $d$ where $d\mid ab^n+c$ for all $n$.
...
ruled out as only containing composites.  Since simple families can contain at
...
numbers $8\cdot23^n+1$, was found to be prime
