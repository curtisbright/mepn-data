...
\[ \begin{tikzpicture}
\node{$\1\{\0,\1,\6\}^*\1$}[sibling distance=6cm]
	child{node{$\1\0\{\0,\1,\6\}^*\1$}[sibling distance=3cm]
		child{node{$\1\0\{\0,\1\}^*\1$}}
		child{node{$\1\0\{\0,\1\}^*\6\{\0\1\}^*\1$}}}
	child{node{$\1\1\{\0,\1,\6\}^*\1$}[sibling distance=3cm]
		child{node{$\1\1\{\0,\1,\6\}^*\1$}}
		child{node{$\1\1\{\0,\1\}^*\6\{\0,\1\}^*\1$}}}
	child{node{$\1\6\{\0,\1,\6\}^*\1$}[sibling distance=1cm]
		child{node{$\1\6\{\1\}^*\1$}}};
\end{tikzpicture} \]
...
22 & 1242 & 764 & 0 \\ 
23\mathrlap{^*} & \geq6019 & \geq119216 & 3 \\ 
24 & 306 & 100 & 0 \\ 
...
Base 23: $\mathtt{80^*81}$, $\mathtt{96E^*}$, $\mathtt{9E^*}$ \\
