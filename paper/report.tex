...
The 28 unsolved families have all been tested to at least length $100{,}000$ without
...
27\mathrlap{^*} & \geq17209 & \geq101106 & 6 \\ 
...
Base 27: $\mathtt{80^*9A}$, $\mathtt{999G^*}$, $\mathtt{A0^*PM}$, $\mathtt{CL^*E}$, $\mathtt{EI^*F8}$, $\mathtt{F^*9FM}$ \\
Base 28: $\mathtt{OA^*F}$
