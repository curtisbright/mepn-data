...
This successfully completes the sequences A111055 and A111056 in the OEIS~\cite{oeis}
which had been missing elements since their introduction to the encyclopedia in 2005.
...
and ``algebraic'' form $(ab^n+c)/d$, where $n$ denotes the number of times the repeated digit
appears in the string representation.  The numbers $a$ and $c$ are given in their factorized form
so as to help spot algebraic factorizations.

\begin{figure}%[H]
\begin{center}\begin{tabular}{ccc}
Base & Family & Algebraic form \\ \hline
17 & $\mathtt{F19^*}$ & $(5\cdot821\cdot17^n-3)/16$ \\
19 & $\mathtt{EE16^*}$ & $(2^2\cdot13\cdot307\cdot19^n-1)/3$ \\
21 & $\mathtt{CF^*0K}$ & $(3\cdot17\cdot21^{n+2}-11\cdot113)/4$ \\
& $\mathtt{G0^*FK}$ & $2^4\cdot3\cdot21^{n+1}+5\cdot67$ \\
...
& $\mathtt{F1^*F1}$ & $(19\cdot25^{n+2}+37\cdot227)/24$ \\
& $\mathtt{F0^*KO}$ & $3\cdot5\cdot25^n+2^2\cdot131$ \\
& $\mathtt{F0K^*O}$ & $(5\cdot11\cdot41\cdot25^{n+1}+19)/6$ \\
& $\mathtt{LOL^*8}$ & $(53\cdot83\cdot25^{n+1}-3\cdot37)/8$ \\
& $\mathtt{M1^*F1}$ & $(23\cdot25^{n+2}+37\cdot227)/24$ \\
& $\mathtt{M10^*8}$ & $19\cdot29\cdot25^{n+1}+2$ \\
& $\mathtt{OL^*8}$ & $(199\cdot25^{n+1}-3\cdot37)/8$ \\
26 & $\mathtt{A^*6F}$ & $(2^2\cdot26^{n+1}-7\cdot71)/5$ \\
& $\mathtt{I^*GL}$ & $(2^2\cdot3^2\cdot26^{n+1}-11\cdot113)/25$ \\
27 & $\mathtt{80^*9A}$ & $2^3\cdot3\cdot27^n+11\cdot23$ \\
& $\mathtt{999G^*}$ & $(101\cdot877\cdot27^n-2)/13$ \\
...
28 & $\mathtt{OA^*F}$ & $(2\cdot7\cdot47\cdot28^{n+1}+5)/27$ \\
29 & $\mathtt{1A^*}$ & $(19\cdot29^n-5)/14$ \\
& $\mathtt{68L0^*6}$ & $7\cdot757\cdot29^{n+1}+2\cdot3$ \\
& $\mathtt{AMP^*}$ & $(8761\cdot29^n-5)/28$ \\
& $\mathtt{C^*FK}$ & $(3\cdot29^{n+1}+2\cdot331)/7$ \\
& $\mathtt{F^*OPF}$ & $(3\cdot5\cdot29^{n+1}+139\cdot1583)/28$ \\
& $\mathtt{FKI^*}$ & $(6379\cdot29^n-3)/14$ \\
& $\mathtt{F^*OP}$ & $(3\cdot5\cdot29^{n+1}+7573)/28$ \\
& $\mathtt{LP09^*}$ & $(31\cdot16607\cdot29^n-3)/28$ \\
& $\mathtt{OOPS^*A}$ & $2\cdot10453\cdot29^{n+1}-19$ \\
& $\mathtt{O0^*FPL}$ & $2^3\cdot3\cdot29^{n+1}+31\cdot431$ \\
& $\mathtt{PC^*}$ & $(2\cdot89\cdot29^n-3)/7$ \\
& $\mathtt{PPPL^*O}$ & $(87103\cdot29^{n+1}+3)/4$ \\
& $\mathtt{Q^*GL}$ & $(13\cdot29^{n+1}-3\cdot1381)/14$ \\
& $\mathtt{Q^*LO}$ & $(13\cdot29^{n+1}-19\cdot109)/14$ \\
...
consisting of 146 elements, the largest of which contained 79 digits.  The On-Line Encyclopedia of Integer Sequences~\cite{oeis}
contains the elements for this minimal set in entry A111055.  Prior to our work, the longest 11 elements were missing
from this listing.
...
can easily be proved prime.  The On-Line Encyclopedia of Integer Sequences~\cite{oeis}
contains the elements for this minimal set in entry A111056.  Prior to our work, the longest 10 elements were missing
from this listing.
...
26\mathrlap{^*} & \geq5662 & \geq8773 & 2 & 254000 \\ 
...
\newblock {\it The On-Line Encyclopedia of Integer Sequences},
\url{http://oeis.org}.
